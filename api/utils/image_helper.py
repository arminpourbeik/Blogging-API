...
def find_image_by_any_format(filename: str, folder: str) -> Union[str, None]:
    """Takes a filename and returns an image on any of accepted formats."""
...
def _retrieve_filename(file: Union[str, FileStorage]) -> str:
    """Take fileStorage and the file name.
    Allows our functions to call this with both filenames and FileStorages and always gets back a file name.
    """
